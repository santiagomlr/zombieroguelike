      ...
      for (let spawnIdx = 0; spawnIdx < spawnCount; spawnIdx++) {
        ...
        if (typeRoll < specialChance) {
          ...
          if (gameState.wave === 1) {
            ...
            // Wave 5: Introducir enemigos fuertes (3-5%)
            if (roll < 0.04) {
              enemyType = "strong";
            ...
            // Wave 8+: Escalado progresivo de fuertes (hasta 25-30%)
            const strongChance = Math.min(0.3, 0.15 + (gameState.wave - 8) * 0.02);
