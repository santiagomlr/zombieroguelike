...
const WEAPONS: Weapon[] = [
  ...
  {
    id: "rocket",
    name: { es: "Lanzacohetes", en: "Rocket Launcher" },
    damage: 8,
    fireRate: 0.5,
    range: 350,
    projectileSpeed: 5,
  ...
  {
    id: "electric",
    name: { es: "Arma Eléctrica", en: "Electric Blaster" },
    damage: 1.5,
    fireRate: 3,
    range: 300,
    projectileSpeed: 10,
  ...
  {
    id: "flamethrower",
    name: { es: "Lanzallamas", en: "Flamethrower" },
    damage: 0.8,
    fireRate: 8,
    range: 150,
    projectileSpeed: 6,
  ...
  {
    id: "frostbow",
    name: { es: "Arco Congelante", en: "Frost Bow" },
    damage: 1.2,
    fireRate: 2,
    range: 350,
    projectileSpeed: 9,
  ...
  {
    id: "homing",
    name: { es: "Misil Teledirigido", en: "Homing Missile" },
    damage: 4,
    fireRate: 1,
    range: 400,
    projectileSpeed: 7,
...
const TOMES: Tome[] = [
  {
    id: "power",
    name: { es: "Tomo de Poder", en: "Tome of Power" },
    description: { es: "+10% Daño", en: "+10% Damage" },
    effect: "damage",
    value: 1.1,
    rarity: "rare",
    color: "#f87171",
  ...
  {
    id: "speed",
    name: { es: "Tomo de Velocidad", en: "Tome of Speed" },
    description: { es: "+5% Velocidad", en: "+5% Speed" },
    effect: "speed",
    value: 1.05,
    rarity: "uncommon",
    color: "#22c55e",
  ...
  {
    id: "bounce",
    name: { es: "Tomo de Rebote", en: "Tome of Bounce" },
    description: { es: "+1 Rebote (Enemigos)", en: "+1 Bounce (Enemies)" },
    effect: "bounce",
    value: 1,
    rarity: "epic",
    color: "#a855f7",
  ...
  {
    id: "range",
    name: { es: "Tomo de Alcance", en: "Tome of Range" },
    description: { es: "+10% Alcance", en: "+10% Range" },
    effect: "range",
    value: 1.1,
    rarity: "uncommon",
    color: "#3b82f6",
  ...
  {
    id: "precision",
    name: { es: "Tomo de Precisión", en: "Tome of Precision" },
    description: { es: "+10% Precisión", en: "+10% Accuracy" },
    effect: "precision",
    value: 1.1,
    rarity: "rare",
    color: "#8b5cf6",
  ...
  {
    id: "multi",
    name: { es: "Tomo Múltiple", en: "Tome of Multishot" },
    description: { es: "+1 Proyectil", en: "+1 Projectile" },
    effect: "multishot",
    value: 1,
    rarity: "legendary",
    color: "#06b6d4",
  ...
  {
    id: "regen",
    name: { es: "Tomo de Regeneración", en: "Tome of Regeneration" },
    description: { es: "Regenera 1 HP cada 5s", en: "Regenerates 1 HP every 5s" },
    effect: "regen",
    value: 1,
    rarity: "uncommon",
    color: "#10b981",
  ...
  {
    id: "magnet",
    name: { es: "Tomo de Magnetismo", en: "Tome of Magnetism" },
    description: { es: "+10% Rango de imán", en: "+10% Magnet Range" },
    effect: "magnet",
    value: 1.1,
    rarity: "common",
    color: "#64748b",
  ...
  {
    id: "fire",
    name: { es: "Tomo de Cadencia", en: "Tome of Haste" },
    description: { es: "+10% Cadencia", en: "+10% Fire Rate" },
    effect: "fireRate",
    value: 1.1,
    rarity: "rare",
    color: "#fbbf24",
...
const ITEMS: Item[] = [
  ...
  {
    id: "windboots",
    name: { es: "Botas de Viento", en: "Wind Boots" },
    description: { es: "+5% velocidad", en: "+5% Speed" },
    effect: "speedboost",
    rarity: "common",
    color: "#9ca3af",
  ...
  {
    id: "fastgloves",
    name: { es: "Guantes Rápidos", en: "Fast Gloves" },
    description: { es: "+5% cadencia", en: "+5% Fire Rate" },
    effect: "firerateitem",
    rarity: "common",
    color: "#9ca3af",
  },
  {
    id: "lightvest",
    name: { es: "Chaleco Ligero", en: "Light Vest" },
    description: { es: "+10 HP máximo", en: "+10 Max HP" },
    effect: "maxhp10",
    rarity: "common",
    color: "#9ca3af",
  },
  {
    id: "tacticalbelt",
    name: { es: "Cinturón Táctico", en: "Tactical Belt" },
    description: { es: "+10% magnetismo", en: "+10% Magnetism" },
    effect: "magnetitem",
    rarity: "common",
    color: "#9ca3af",
  },
  {
    id: "oldclock",
    name: { es: "Reloj Antiguo", en: "Old Clock" },
    description: { es: "+5% duración powerups", en: "+5% Powerup duration" },
  ...
  {
    id: "rustyring",
    name: { es: "Anillo Oxidado", en: "Rusty Ring" },
    description: { es: "+10 XP por kill", en: "+10 XP per kill" },
    effect: "xpbonus",
    rarity: "common",
    color: "#9ca3af",
  },
  ...
  {
    id: "combatglasses",
    name: { es: "Gafas de Combate", en: "Combat Goggles" },
    description: { es: "+10% precisión", en: "+10% Accuracy" },
  ...
  {
    id: "reinforcedpants",
    name: { es: "Pantalones Reforzados", en: "Reinforced Pants" },
    description: { es: "-5% daño recibido", en: "-5% Damage taken" },
  ...
  {
    id: "bouncegloves",
    name: { es: "Guantes de Rebote", en: "Bounce Gloves" },
    description: { es: "+1 rebote", en: "+1 Bounce" },
    effect: "bounceitem",
    rarity: "rare",
    color: "#3b82f6",
  },
  ...
  {
    id: "energyclock",
    name: { es: "Reloj de Energía", en: "Energy Clock" },
    description: { es: "+10% cadencia global", en: "+10% Global fire rate" },
  ...
  {
    id: "ballistichelmet",
    name: { es: "Casco Balístico", en: "Ballistic Helmet" },
    description: { es: "Inmunidad 1er golpe/wave", en: "Immune to first hit each wave" },
  ...
  {
    id: "jetboots",
    name: { es: "Botas Jet", en: "Jet Boots" },
    description: { es: "+15% velocidad", en: "+15% Speed" },
    effect: "jetspeed",
    rarity: "epic",
    color: "#a855f7",
  },
  {
    id: "reactiveshield",
    name: { es: "Escudo Reactivo", en: "Reactive Shield" },
    description: { es: "Onda empuja enemigos", en: "Shockwave pushes enemies" },
  ...
  {
    id: "chaosamuleto",
    name: { es: "Amuleto del Caos", en: "Chaos Amulet" },
    description: { es: "Daño +10% a +50%", en: "Damage +10% to +50%" },
    effect: "chaosdamage",
    rarity: "epic",
    color: "#a855f7",
  },
  {
    id: "ironmedal",
    name: { es: "Medalla de Hierro", en: "Iron Medal" },
    description: { es: "+15% HP máximo", en: "+15% Max HP" },
    effect: "maxhp15",
    rarity: "epic",
    color: "#a855f7",
  },
  {
    id: "heavyvest",
    name: { es: "Chaleco Pesado", en: "Heavy Vest" },
    description: { es: "-10% velocidad, -25% daño recibido", en: "-10% Speed, -25% Damage taken" },
    effect: "heavyarmor",
    rarity: "epic",
    color: "#a855f7",
  },
  {
    id: "plasmafragment",
    name: { es: "Fragmento de Plasma", en: "Plasma Fragment" },
    description: { es: "+1 rebote +15% alcance", en: "+1 Bounce +15% Range" },
    effect: "plasmafrag",
    rarity: "epic",
    color: "#a855f7",
  },
  ...
  {
    id: "voidcore",
    name: { es: "Núcleo del Vacío", en: "Void Core" },
    description: { es: "XP Doble", en: "Double XP" },
    effect: "doublexp",
    rarity: "legendary",
    color: "#fbbf24",
  },
  {
    id: "solargauntlet",
    name: { es: "Guantelete Solar", en: "Solar Gauntlet" },
    description: { es: "Proyectil cada 10 kills", en: "Projectile every 10 kills" },
  ...
  {
    id: "infernalengine",
    name: { es: "Motor Infernal", en: "Infernal Engine" },
    description: { es: "+25% velocidad +20% daño, +10% daño recibido", en: "+25% Speed +20% Damage, +10% Damage taken" },
  ...
  {
    id: "bloodstone",
    name: { es: "Piedra de Sangre", en: "Bloodstone" },
    description: { es: "5 HP cada 30 kills", en: "5 HP every 30 kills" },
    effect: "bloodstone",
    rarity: "legendary",
    color: "#fbbf24",
  },
  {
    id: "hordetotem",
    name: { es: "Tótem de la Horda", en: "Horde Totem" },
    description: { es: "+1 enemigo spawn, +2 XP/kill", en: "+1 Enemy spawn, +2 XP/kill" },
    effect: "hordetotem",
    rarity: "legendary",
    color: "#fbbf24",
  },
  {
    id: "artificialheart",
    name: { es: "Corazón Artificial", en: "Artificial Heart" },
    description: { es: "+50 HP permanente", en: "+50 Permanent HP" },
  ...
  {
    id: "infinitylens",
    name: { es: "Lente del Infinito", en: "Infinity Lens" },
    description: { es: "+10% todos los stats", en: "+10% All stats" },
    effect: "infinitylens",
    rarity: "legendary",
    color: "#fbbf24",
  },
  ...
  useEffect(() => {
      ...
      if (option.type === "weapon") {
        ...
        if (option.isLevelUp && option.targetIndex !== undefined) {
          ...
          if (existingTome.effect === "damage") {
            ...
            existingTome.description = {
              es: `+${existingTome.level * 10}% Daño`,
              en: `+${existingTome.level * 10}% Damage`,
            };
            ...
            if (currentLevel < 5) {
              ...
              existingTome.description = {
                es: `+${existingTome.level * 5}% Velocidad`,
                en: `+${existingTome.level * 5}% Speed`,
              };
            }
            ...
            if (currentLevel < 5) {
              ...
              existingTome.description = {
                es: `${gameState.player.stats.bounces} Rebotes (Enemigos)`,
                en: `${gameState.player.stats.bounces} Bounces (Enemies)`,
              };
            }
            ...
            if (currentLevel < 5) {
              ...
              existingTome.description = {
                es: `+${percentages[currentLevel]}% Alcance`,
                en: `+${percentages[currentLevel]}% Range`,
              };
            }
            ...
            if (currentLevel < 5) {
              ...
              existingTome.description = {
                es: `+${gameState.player.stats.precision}% Precisión`,
                en: `+${gameState.player.stats.precision}% Accuracy`,
              };
            }
            ...
            existingTome.description = {
              es: `+${gameState.player.stats.multishot + 1} Proyectiles`,
              en: `+${gameState.player.stats.multishot + 1} Projectiles`,
            };
            ...
            if (currentLevel < regenLevels.length) {
              ...
              existingTome.description = {
                es: `Regen ${config.rate} HP cada ${config.interval}s`,
                en: `Regen ${config.rate} HP every ${config.interval}s`,
              };
            } else {
              ...
              existingTome.description = {
                es: `Regen ${gameState.player.stats.regenRate} HP cada 4s`,
                en: `Regen ${gameState.player.stats.regenRate} HP every 4s`,
              };
            }
            ...
            if (currentLevel < 5) {
              ...
              existingTome.description = {
                es: `+${totalBonus}% Rango imán`,
                en: `+${totalBonus}% Magnet Range`,
              };
            }
            ...
            existingTome.description = {
              es: `+${totalBonus}% Cadencia`,
              en: `+${totalBonus}% Fire Rate`,
            };
          }
        } else {
          // Nuevo tomo
    ...
    canvas.addEventListener("click", (e) => {
      ...
      if (gameState.showUpgradeUI) {
        ...
        // Pause menu click handler - NUEVO DISEÑO CON TABS (NO durante countdown)
        if (gameState.showAudioSettings) {
          ...
          // Back button (ajustado para nuevas coordenadas)
          const backBtnW = 300;
          const backBtnH = 65;
          const backBtnX = centerX - backBtnW / 2;
          const backBtnY = audioY + audioH - 95;
          ...
          // CLICKS EN MENU PRINCIPAL CON 3 TABS
          const menuW = 700;
          const menuH = 700;
          ...
          // Tab buttons (Settings / Wiki / Credits)
          const tabBtnW = 130;
          const tabBtnH = 45;
          const tabGap = 12;
          const totalTabWidth = tabBtnW * 3 + tabGap * 2;
          const settingsTabX = centerX - totalTabWidth / 2;
          const wikiTabX = settingsTabX + tabBtnW + tabGap;
          const creditsTabX = wikiTabX + tabBtnW + tabGap;
          const tabY = menuY + 85;
          
          // Settings tab click
          if (mx >= settingsTabX && mx <= settingsTabX + tabBtnW && my >= tabY && my <= tabY + tabBtnH) {
            gameState.pauseMenuTab = "settings";
            return;
          }
          
          // Wiki tab click
          if (mx >= wikiTabX && mx <= wikiTabX + tabBtnW && my >= tabY && my <= tabY + tabBtnH) {
            gameState.pauseMenuTab = "wiki";
            return;
          }
          
          // Credits tab click
          if (mx >= creditsTabX && mx <= creditsTabX + tabBtnW && my >= tabY && my <= tabY + tabBtnH) {
            gameState.pauseMenuTab = "credits";
            return;
          }
    ...
    function drawHUD() {
      ...
      ctx.fillText(currentTranslations.weapons, W - 220, 70);
      for (let i = 0; i < gameState.player.weapons.length; i++) {
        const w = gameState.player.weapons[i];
        ...
        const weaponName = getLocalizedText(w.name, currentLanguage);
      ...
      ctx.fillText(currentTranslations.tomes, W - 220, tomeY);
      for (let i = 0; i < gameState.player.tomes.length; i++) {
        ...
        ctx.fillStyle = "#fff";
        ctx.font = "12px system-ui";
        const tomeName = getLocalizedText(tome.name, currentLanguage);
      ...
      if (gameState.player.items.length > 0) {
        ...
        ctx.fillText(currentTranslations.items, W - 220, itemY);
        ...
        for (let i = 0; i < maxItemsToShow; i++) {
          ...
          const itemNameFull = getLocalizedText(item.name, currentLanguage);
    ...
    function drawUpgradeUI() {
      ...
      ctx.font = "bold 56px system-ui";
      ctx.textAlign = "center";
      ctx.fillText(currentTranslations.levelUp, 0, 0);
      ...
      ctx.textAlign = "center";
      ctx.fillText(currentTranslations.chooseUpgrade, W / 2, H / 2 - 100);
      ...
      for (let i = 0; i < gameState.upgradeOptions.length; i++) {
        ...
        const typeText =
          option.type === "weapon"
            ? `⚔️ ${currentTranslations.weapon}`
            : option.type === "tome"
            ? `📖 ${currentTranslations.tome}`
        ...
        const localizedName = getLocalizedText(data.name, currentLanguage);
        ctx.fillStyle = "#fff";
        ctx.font = "bold 22px system-ui";
        ctx.shadowColor = "#000";
        ctx.shadowBlur = 4;
        const nameText = option.isLevelUp ? `${localizedName} ★${data.level + 1}` : localizedName;
        ...
        if (option.type === "weapon") {
          ...
          if (option.isLevelUp && option.description) {
            ...
            ctx.textAlign = "left";
            const statsX = x + 20;
            ctx.fillText(`💥 ${currentTranslations.damage}: ${w.damage.toFixed(1)}`, statsX, yOffset + 110);
            ctx.fillText(`⚡ ${currentTranslations.fireRate}: ${w.fireRate.toFixed(1)}/s`, statsX, yOffset + 135);
            ctx.fillText(`🎯 ${currentTranslations.range}: ${w.range}`, statsX, yOffset + 160);
            ctx.textAlign = "center";
          }
        } else if (option.type === "tome") {
          const tome = data as Tome;
          const desc = option.isLevelUp && option.description
            ? option.description
            : getLocalizedText(tome.description, currentLanguage);
          wrapText(ctx, desc, x + cardW / 2, yOffset + 110, maxWidth, 20);
        } else {
          wrapText(
            ctx,
            getLocalizedText((data as Item).description, currentLanguage),
            x + cardW / 2,
            yOffset + 110,
            maxWidth,
            20
    ...
    function draw() {
      ...
      if (gameState.state === 'paused' && !gameState.showUpgradeUI && gameState.countdownTimer <= 0) {
        ...
        if (gameState.showWiki) {
          ...
          const leftMargin = wikiX + 35;
          
          // Sección 1: Pickups (Objetos que se dropean)
          ctx.fillStyle = "#fbbf24";
          ctx.font = "bold 24px system-ui";
          ctx.textAlign = "left";
          ctx.shadowColor = "#fbbf24";
          ...
          for (const pickup of pickups) {
            ...
            ctx.fillStyle = "#fff";
            ctx.font = "bold 16px system-ui";
            ctx.fillText(pickup.name, leftMargin + 40, contentY);
            ctx.fillStyle = "#9ca3af";
            ctx.font = "15px system-ui";
            ctx.fillText(`— ${pickup.desc}`, leftMargin + 200, contentY);
            contentY += 26;
          }
          
          contentY += 15;
          
          // Sección 2: Sistema de Mejoras
          ctx.fillStyle = "#fbbf24";
          ctx.font = "bold 24px system-ui";
          ctx.shadowColor = "#fbbf24";
          ctx.shadowBlur = 8;
          ...
          for (const type of upgradeTypes) {
            ...
            ctx.font = "bold 16px system-ui";
            ctx.fillText(`${type.icon} ${type.name}:`, leftMargin + 20, contentY);
            ctx.fillStyle = "#9ca3af";
            ctx.font = "14px system-ui";
            ctx.fillText(type.desc, leftMargin + 170, contentY);
            contentY += 24;
          }
          ...
          for (const enemy of enemies) {
            ...
            ctx.fillText(`${enemy.icon} ${enemy.name}`, leftMargin + 15, contentY);
            ctx.fillStyle = "#9ca3af";
            ctx.font = "14px system-ui";
            ctx.fillText(`— ${enemy.desc}`, leftMargin + 180, contentY);
            contentY += 24;
          }
          ...
          // Sección 4: Créditos
          ctx.save();
          // Fondo especial para créditos con gradiente mejorado
          const creditsBg = ctx.createLinearGradient(wikiX, contentY - 15, wikiX, contentY + 75);
          creditsBg.addColorStop(0, "rgba(168, 85, 247, 0.15)");
          creditsBg.addColorStop(0.5, "rgba(251, 191, 36, 0.1)");
          creditsBg.addColorStop(1, "rgba(0, 0, 0, 0.5)");
          ctx.fillStyle = creditsBg;
          ctx.fillRect(wikiX + 25, contentY - 15, wikiW - 50, 80);
          
          // Borde del panel de créditos
          ctx.strokeStyle = "rgba(168, 85, 247, 0.4)";
          ctx.lineWidth = 2;
          ctx.strokeRect(wikiX + 25, contentY - 15, wikiW - 50, 80);
          ctx.restore();
          ...
          const backBtnY = wikiY + wikiH - 85;
          
          const backGradient = ctx.createLinearGradient(backBtnX, backBtnY, backBtnX, backBtnY + backBtnH);
          backGradient.addColorStop(0, "#7c3aed");
          backGradient.addColorStop(1, "#5b21b6");
          ctx.fillStyle = backGradient;
          ctx.beginPath();
          ctx.roundRect(backBtnX, backBtnY, backBtnW, backBtnH, 14);
          ctx.fill();
          ...
          // Background con gradiente
          const audioBg = ctx.createLinearGradient(audioX, audioY, audioX, audioY + audioH);
          audioBg.addColorStop(0, "rgba(20, 25, 35, 0.98)");
          audioBg.addColorStop(1, "rgba(30, 35, 45, 0.98)");
          ...
          ctx.shadowColor = "#a855f7";
          ctx.shadowBlur = 10;
          ctx.fillText("🎧 Audio Settings", W / 2, audioY + 60);
          ctx.shadowBlur = 0;
          
          let audioContentY = audioY + 120;
          ...
          ctx.textAlign = "left";
          const sliderX = audioX + 80;
          ctx.fillText("🎚️ Volumen Música", sliderX, audioContentY);
          
          // Porcentaje
          ctx.fillStyle = "#a855f7";
          ctx.textAlign = "right";
          const sliderW = 440;
          ctx.fillText(`${Math.round(gameState.musicVolume * 100)}%`, sliderX + sliderW, audioContentY);
          ...
          ctx.beginPath();
          ctx.roundRect(sliderX, audioContentY, sliderW, sliderH, 7);
          ctx.fill();
          ctx.shadowBlur = 0;
          ...
          ctx.beginPath();
          ctx.roundRect(sliderX, audioContentY, fillW, sliderH, 7);
          ctx.fill();
          
          // Handle del slider
          const handleX = sliderX + fillW;
          const handleY = audioContentY + sliderH / 2;
          const handleRadius = 18;
          ...
          // Music button - mejorado
          const musicGradient = ctx.createLinearGradient(toggleX1, audioContentY, toggleX1, audioContentY + toggleBtnH);
          if (gameState.musicMuted) {
            musicGradient.addColorStop(0, "#dc2626");
            musicGradient.addColorStop(0.5, "#b91c1c");
            musicGradient.addColorStop(1, "#991b1b");
          } else {
            musicGradient.addColorStop(0, "#10b981");
            musicGradient.addColorStop(0.5, "#059669");
            musicGradient.addColorStop(1, "#047857");
          }
          ...
          ctx.shadowBlur = 25;
          ctx.beginPath();
          ctx.roundRect(toggleX1, audioContentY, toggleBtnW, toggleBtnH, 12);
          ctx.fill();
          
          ctx.strokeStyle = gameState.musicMuted ? "#f87171" : "#34d399";
          ctx.lineWidth = 2;
          ctx.shadowBlur = 20;
          ctx.stroke();
          ctx.shadowBlur = 0;
          ...
          ctx.save();
          ctx.globalAlpha = 0.3;
          const musicHighlight = ctx.createLinearGradient(toggleX1, audioContentY, toggleX1, audioContentY + toggleBtnH / 3);
          musicHighlight.addColorStop(0, "rgba(255, 255, 255, 0.7)");
          musicHighlight.addColorStop(1, "rgba(255, 255, 255, 0)");
          ctx.fillStyle = musicHighlight;
          ctx.beginPath();
          ctx.roundRect(toggleX1 + 3, audioContentY + 3, toggleBtnW - 6, toggleBtnH / 3, 9);
          ctx.fill();
          ctx.restore();
          ...
          ctx.shadowColor = "rgba(0, 0, 0, 0.5)";
          ctx.shadowBlur = 4;
          ctx.fillText(gameState.musicMuted ? "🔇 Música" : "🎵 Música", toggleX1 + toggleBtnW / 2, audioContentY + toggleBtnH / 2 + 8);
          ctx.shadowBlur = 0;
          
          // SFX button - mejorado
          const sfxGradient = ctx.createLinearGradient(toggleX2, audioContentY, toggleX2, audioContentY + toggleBtnH);
          if (gameState.sfxMuted) {
            sfxGradient.addColorStop(0, "#dc2626");
            sfxGradient.addColorStop(0.5, "#b91c1c");
            sfxGradient.addColorStop(1, "#991b1b");
          } else {
            sfxGradient.addColorStop(0, "#10b981");
            sfxGradient.addColorStop(0.5, "#059669");
            sfxGradient.addColorStop(1, "#047857");
          }
          ...
          ctx.shadowBlur = 25;
          ctx.beginPath();
          ctx.roundRect(toggleX2, audioContentY, toggleBtnW, toggleBtnH, 12);
          ctx.fill();
          
          ctx.strokeStyle = gameState.sfxMuted ? "#f87171" : "#34d399";
          ctx.lineWidth = 2;
          ctx.shadowBlur = 20;
          ctx.stroke();
          ctx.shadowBlur = 0;
          ...
          ctx.save();
          ctx.globalAlpha = 0.3;
          const sfxHighlight = ctx.createLinearGradient(toggleX2, audioContentY, toggleX2, audioContentY + toggleBtnH / 3);
          sfxHighlight.addColorStop(0, "rgba(255, 255, 255, 0.7)");
          sfxHighlight.addColorStop(1, "rgba(255, 255, 255, 0)");
          ctx.fillStyle = sfxHighlight;
          ctx.beginPath();
          ctx.roundRect(toggleX2 + 3, audioContentY + 3, toggleBtnW - 6, toggleBtnH / 3, 9);
          ctx.fill();
          ctx.restore();
          ...
          ctx.shadowColor = "rgba(0, 0, 0, 0.5)";
          ctx.shadowBlur = 4;
          ctx.fillText(gameState.sfxMuted ? "🔇 SFX" : "🔊 SFX", toggleX2 + toggleBtnW / 2, audioContentY + toggleBtnH / 2 + 8);
          ctx.shadowBlur = 0;
          ...
          const backGradient = ctx.createLinearGradient(backBtnX, backBtnY, backBtnX, backBtnY + backBtnH);
          backGradient.addColorStop(0, "#7c3aed");
          backGradient.addColorStop(0.5, "#6d28d9");
          backGradient.addColorStop(1, "#5b21b6");
          ctx.fillStyle = backGradient;
          ...
          ctx.save();
          ctx.globalAlpha = 0.3;
          const backHighlight = ctx.createLinearGradient(backBtnX, backBtnY, backBtnX, backBtnY + backBtnH / 3);
          backHighlight.addColorStop(0, "rgba(255, 255, 255, 0.7)");
          backHighlight.addColorStop(1, "rgba(255, 255, 255, 0)");
          ctx.fillStyle = backHighlight;
          ctx.beginPath();
          ctx.roundRect(backBtnX + 3, backBtnY + 3, backBtnW - 6, backBtnH / 3, 11);
          ctx.fill();
          ctx.restore();
          ...
          // MENU PRINCIPAL DE PAUSA CON 3 TABS
          const menuW = 700;
          const menuH = 720;
          const menuX = W / 2 - menuW / 2;
          const menuY = H / 2 - menuH / 2;
          ...
          // Settings Tab
          const settingsTabGradient = ctx.createLinearGradient(settingsTabX, tabY, settingsTabX, tabY + tabBtnH);
          if (gameState.pauseMenuTab === "settings") {
            settingsTabGradient.addColorStop(0, "#fbbf24");
            settingsTabGradient.addColorStop(0.5, "#f59e0b");
            settingsTabGradient.addColorStop(1, "#d97706");
          } else {
            settingsTabGradient.addColorStop(0, "#4b5563");
            settingsTabGradient.addColorStop(0.5, "#374151");
            settingsTabGradient.addColorStop(1, "#1f2937");
          }
          ctx.fillStyle = settingsTabGradient;
          ...
          ctx.beginPath();
          ctx.roundRect(settingsTabX, tabY, tabBtnW, tabBtnH, 10);
          ctx.fill();
          ctx.shadowBlur = 0;
          ...
          if (gameState.pauseMenuTab === "settings") {
            ...
            ctx.save();
            ctx.globalAlpha = 0.3;
            const settingsHighlight = ctx.createLinearGradient(settingsTabX, tabY, settingsTabX, tabY + tabBtnH / 3);
            settingsHighlight.addColorStop(0, "rgba(255, 255, 255, 0.7)");
            settingsHighlight.addColorStop(1, "rgba(255, 255, 255, 0)");
            ctx.fillStyle = settingsHighlight;
            ctx.beginPath();
            ctx.roundRect(settingsTabX + 2, tabY + 2, tabBtnW - 4, tabBtnH / 3, 8);
            ctx.fill();
            ctx.restore();
          } else {
          ...
          ctx.fillStyle = "#fff";
          ctx.font = gameState.pauseMenuTab === "settings" ? "bold 16px system-ui" : "15px system-ui";
          ctx.textAlign = "center";
          ctx.shadowColor = "rgba(0, 0, 0, 0.5)";
          ctx.shadowBlur = 3;
          ctx.fillText("⚙️ Settings", settingsTabX + tabBtnW / 2, tabY + tabBtnH / 2 + 6);
          ctx.shadowBlur = 0;
          
          // Wiki Tab
          const wikiTabGradient = ctx.createLinearGradient(wikiTabX, tabY, wikiTabX, tabY + tabBtnH);
          if (gameState.pauseMenuTab === "wiki") {
            wikiTabGradient.addColorStop(0, "#3b82f6");
            wikiTabGradient.addColorStop(0.5, "#2563eb");
            wikiTabGradient.addColorStop(1, "#1e40af");
          } else {
            wikiTabGradient.addColorStop(0, "#4b5563");
            wikiTabGradient.addColorStop(0.5, "#374151");
            wikiTabGradient.addColorStop(1, "#1f2937");
          }
          ctx.fillStyle = wikiTabGradient;
          ...
          ctx.beginPath();
          ctx.roundRect(wikiTabX, tabY, tabBtnW, tabBtnH, 10);
          ctx.fill();
          ctx.shadowBlur = 0;
          ...
          if (gameState.pauseMenuTab === "wiki") {
            ...
            ctx.save();
            ctx.globalAlpha = 0.3;
            const wikiHighlight = ctx.createLinearGradient(wikiTabX, tabY, wikiTabX, tabY + tabBtnH / 3);
            wikiHighlight.addColorStop(0, "rgba(255, 255, 255, 0.7)");
            wikiHighlight.addColorStop(1, "rgba(255, 255, 255, 0)");
            ctx.fillStyle = wikiHighlight;
            ctx.beginPath();
            ctx.roundRect(wikiTabX + 2, tabY + 2, tabBtnW - 4, tabBtnH / 3, 8);
            ctx.fill();
            ctx.restore();
          } else {
            ctx.strokeStyle = "#6b7280";
          ...
          ctx.fillStyle = "#fff";
          ctx.font = gameState.pauseMenuTab === "wiki" ? "bold 16px system-ui" : "15px system-ui";
          ctx.shadowColor = "rgba(0, 0, 0, 0.5)";
          ctx.shadowBlur = 3;
          ctx.fillText("📚 Wiki", wikiTabX + tabBtnW / 2, tabY + tabBtnH / 2 + 6);
          ctx.shadowBlur = 0;
          
          // Credits Tab
          const creditsTabGradient = ctx.createLinearGradient(creditsTabX, tabY, creditsTabX, tabY + tabBtnH);
          if (gameState.pauseMenuTab === "credits") {
            creditsTabGradient.addColorStop(0, "#a855f7");
            creditsTabGradient.addColorStop(0.5, "#9333ea");
            creditsTabGradient.addColorStop(1, "#7e22ce");
          } else {
            creditsTabGradient.addColorStop(0, "#4b5563");
            creditsTabGradient.addColorStop(0.5, "#374151");
            creditsTabGradient.addColorStop(1, "#1f2937");
          }
          ctx.fillStyle = creditsTabGradient;
          ...
          ctx.beginPath();
          ctx.roundRect(creditsTabX, tabY, tabBtnW, tabBtnH, 10);
          ctx.fill();
          ctx.shadowBlur = 0;
          ...
          if (gameState.pauseMenuTab === "credits") {
            ...
            ctx.save();
            ctx.globalAlpha = 0.3;
            const creditsHighlight = ctx.createLinearGradient(creditsTabX, tabY, creditsTabX, tabY + tabBtnH / 3);
            creditsHighlight.addColorStop(0, "rgba(255, 255, 255, 0.7)");
            creditsHighlight.addColorStop(1, "rgba(255, 255, 255, 0)");
            ctx.fillStyle = creditsHighlight;
            ctx.beginPath();
            ctx.roundRect(creditsTabX + 2, tabY + 2, tabBtnW - 4, tabBtnH / 3, 8);
            ctx.fill();
            ctx.restore();
          } else {
            ctx.strokeStyle = "#6b7280";
          ...
          ctx.fillStyle = "#fff";
          ctx.font = gameState.pauseMenuTab === "credits" ? "bold 16px system-ui" : "15px system-ui";
          ctx.shadowColor = "rgba(0, 0, 0, 0.5)";
          ctx.shadowBlur = 3;
          ctx.fillText("⚡ Créditos", creditsTabX + tabBtnW / 2, tabY + tabBtnH / 2 + 6);
          ctx.shadowBlur = 0;
          
          // === CONTENIDO SEGÚN TAB ===
          if (gameState.pauseMenuTab === "wiki") {
            // === TAB DE WIKI ===
            let contentY = menuY + 155;
            const leftMargin = menuX + 35;
            ...
            const pickups = [
              { icon: "💎", color: "#3b82f6", name: "Gema de XP", desc: "Sube tu nivel" },
              { icon: "❤️", color: "#ef4444", name: "Corazón", desc: "+20 HP de curación" },
              { icon: "⭐", color: "#fbbf24", name: "Powerup", desc: "Mejora temporal" },
            ];
            ...
            // Tipos de enemigos (VERSIÓN ORIGINAL)
            ctx.fillStyle = "#fbbf24";
            ctx.font = "bold 24px system-ui";
            ctx.shadowColor = "#fbbf24";
            ctx.shadowBlur = 8;
            ...
            ctx.font = "15px system-ui";
            ctx.fillStyle = "#d1d5db";
            ctx.fillText("Al subir de nivel, elige entre:", leftMargin + 10, contentY);
            contentY += 28;
            
            const upgradeTypes = [
              { icon: "🔫", color: "#f87171", name: "ARMAS", desc: "Pistola, SMG, Láser, etc." },
              { icon: "📖", color: "#a855f7", name: "TOMOS", desc: "Rebote, Multi-shot, Poder" },
              { icon: "🎒", color: "#fbbf24", name: "ÍTEMS", desc: "Pasivos permanentes" },
            ];
            ...
            // === TAB DE CRÉDITOS ===
            let contentY = menuY + menuH / 2 - 40;
            
            // Fondo decorativo
            ctx.save();
            const creditsBg = ctx.createLinearGradient(menuX, contentY - 30, menuX, contentY + 120);
            creditsBg.addColorStop(0, "rgba(168, 85, 247, 0.15)");
            creditsBg.addColorStop(0.5, "rgba(251, 191, 36, 0.1)");
            creditsBg.addColorStop(1, "rgba(0, 0, 0, 0.5)");
            ctx.fillStyle = creditsBg;
            ctx.fillRect(menuX + 40, contentY - 30, menuW - 80, 150);
            
            // Borde
            ctx.strokeStyle = "rgba(168, 85, 247, 0.4)";
            ctx.lineWidth = 2;
            ctx.strokeRect(menuX + 40, contentY - 30, menuW - 80, 150);
            ctx.restore();
            ...
            ctx.font = "bold 22px system-ui";
            ctx.textAlign = "left";
            ctx.fillText("📊 Estadísticas Generales", leftCol, contentY);
            contentY += 10;
            ...
            ctx.font = "bold 14px system-ui";
            ctx.textAlign = "center";
            ctx.fillText(`${gameState.player.hp}/${gameState.player.maxhp}`, hpBarX + hpBarW / 2, contentY);
            contentY += 45;
            ...
            ctx.font = "16px system-ui";
            ctx.fillStyle = "#9ca3af";
            ctx.fillText(`${currentTranslations.weapons} ${gameState.player.weapons.length}/3`, leftCol, contentY);
            ctx.fillText(`${currentTranslations.tomes} ${gameState.player.tomes.length}/3`, rightCol, contentY);
            contentY += 25;
            
            // Items
            const maxItems = Math.max(gameState.player.weapons.length, gameState.player.tomes.length, 1);
            for (let i = 0; i < maxItems; i++) {
              if (i < gameState.player.weapons.length) {
                const w = gameState.player.weapons[i];
                ctx.fillStyle = w.color;
                const weaponName = getLocalizedText(w.name, currentLanguage);
                ctx.fillText(`• ${weaponName} (Lv.${w.level})`, leftCol + 10, contentY);
              }
              if (i < gameState.player.tomes.length) {
                const tome = gameState.player.tomes[i];
                ctx.fillStyle = tome.color;
                const tomeName = getLocalizedText(tome.name, currentLanguage);
                ctx.fillText(`• ${tomeName} (Lv.${tome.level})`, rightCol + 10, contentY);
              }
              contentY += 24;
            }
          } else if (gameState.pauseMenuTab === "settings") {
            ...
            for (const { mode, label, x } of aimModes) {
              ...
              // Gradiente mejorado
              const btnGradient = ctx.createLinearGradient(x, contentY, x, contentY + aimBtnH);
              if (isSelected) {
                btnGradient.addColorStop(0, "#a855f7");
                btnGradient.addColorStop(0.5, "#9333ea");
              ...
              ctx.beginPath();
              ctx.roundRect(x, contentY, aimBtnW, aimBtnH, 10);
              ctx.fill();
              ctx.shadowBlur = 0;
              ...
              if (isSelected) {
                ...
                ctx.save();
                ctx.globalAlpha = 0.3;
                const highlight = ctx.createLinearGradient(x, contentY, x, contentY + aimBtnH / 3);
                highlight.addColorStop(0, "rgba(255, 255, 255, 0.6)");
                highlight.addColorStop(1, "rgba(255, 255, 255, 0)");
                ctx.fillStyle = highlight;
                ctx.beginPath();
                ctx.roundRect(x + 2, contentY + 2, aimBtnW - 4, aimBtnH / 3, 8);
                ctx.fill();
                ctx.restore();
              } else {
                ctx.strokeStyle = "#6b7280";
